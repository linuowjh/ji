...
type User struct {
	...
	WechatOpenID  string         `json:"wechat_openid" gorm:"column:wechat_open_id;uniqueIndex;type:varchar(100);not null;comment:微信OpenID"`
	WechatUnionID string         `json:"wechat_unionid" gorm:"column:wechat_union_id;type:varchar(100);comment:微信UnionID"`
	Nickname      string         `json:"nickname" gorm:"type:varchar(50);comment:用户昵称"`
	AvatarURL     string         `json:"avatar_url" gorm:"column:avatar_url;type:varchar(255);comment:头像URL"`
